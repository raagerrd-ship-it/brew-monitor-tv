      ...
      <div className={isMobile ? '' : 'flex-1 overflow-y-auto'} style={isMobile ? { paddingTop: `${headerControllers.length > 0 ? 136 : 72}px` } : undefined}>
        ...
        <Tabs value={initialTab} onValueChange={handleTabChange} className="w-full">
          ...
          <TabsContent value="automation" className="space-y-6">
            {/* GLYCOL COOLER — Enable + Controller Selection */}
            <SettingsSection
              icon={Snowflake}
              title="Glykolkylare"
              description="Välj vilken controller som är kylaren och vilka jästankar den ska följa"
            >
            ...
            {autoCoolingEnabled && (
              <SettingsSection
                icon={Cpu}
                title="Justeringsparametrar"
                description="Styr hur aggressivt kylaren justeras"
              >
