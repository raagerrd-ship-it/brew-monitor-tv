    ...
    <div className="h-screen w-screen bg-background flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-2 border-b border-border/50 backdrop-blur-sm bg-background/80 flex-shrink-0">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center min-w-[280px] justify-end mr-2">
            <RaptPills />
          </div>
          ...
          <div className="relative flex items-center justify-center w-10 h-10">
            <Button
              ...
              className="opacity-40 hover:opacity-100 hover:bg-transparent transition-all duration-300 w-10 h-10 group"
            >
              <Settings className="h-4 w-4 transition-all duration-300 group-hover:[fill:hsl(var(--primary))]" />
            </Button>
