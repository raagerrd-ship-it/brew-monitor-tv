              ...
              <div className="h-[39%] p-2 pt-1 pb-2 flex-shrink-0">
                <div className="grid grid-cols-3 gap-2 h-full">
                  ...
                  <div 
                    ...
                    style={{ containerType: 'size' }}
                  >
                    <div className="absolute top-1/2 -translate-y-1/2 right-2 opacity-20" style={{ width: '70%', height: '70%' }}>
                  ...
                  >
                    <div className="absolute top-1/2 -translate-y-1/2 right-2 opacity-20 animate-pulse" style={{ width: '70%', height: '70%' }}>
                      <svg viewBox="0 0 24 24" fill="none" className="w-full h-full">
                        {/* Thermometer outline */}
                        <path 
                  ...
                  <div 
                    ...
                    style={{ containerType: 'size' }}
                  >
                    <div className="absolute top-1/2 -translate-y-1/2 right-0 opacity-20" style={{ width: '65%', height: '65%' }}>
                      <svg viewBox="0 0 24 24" fill="none" className="w-full h-full">
