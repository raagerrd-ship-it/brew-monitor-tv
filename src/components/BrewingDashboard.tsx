              ...
              <div className="h-[37%] p-2 pt-0 pb-2 flex-shrink-0">
                <div className="grid grid-cols-3 gap-2 h-full">
                  ...
                  <div 
                    ...
                    style={{ containerType: 'size' }}
                  >
                    <div className="absolute top-1/2 -translate-y-1/2 -right-3 opacity-20" style={{ width: '65%', height: '65%', transform: 'translateY(-50%) rotate(45deg)' }}>
                  ...
                  <div 
                    ...
                    style={{ containerType: 'size' }}
                  >
                    <div className="absolute top-1/2 -translate-y-1/2 -right-3 opacity-20" style={{ width: '65%', height: '65%' }}>
