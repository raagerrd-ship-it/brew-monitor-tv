              ...
              <div className="h-[39%] p-2 pt-1 pb-2 flex-shrink-0">
                <div className="grid grid-cols-3 gap-2 h-full">
                  ...
                  <div 
                    ...
                    style={{ containerType: 'size' }}
                  >
                    <div className="absolute top-1/2 -translate-y-1/2 -right-6 opacity-20" style={{ width: '60%', height: '60%' }}>
                  ...
                  >
                    <div className="absolute top-1/2 -translate-y-1/2 -right-6 opacity-20 animate-pulse" style={{ width: '60%', height: '60%' }}>
                      <svg viewBox="0 0 24 24" fill="none" className="w-full h-full">
                        {/* Thermometer outline */}
                        <path 
                  ...
                  <div 
                    ...
                    style={{ containerType: 'size' }}
                  >
                    <div className="absolute top-1/2 -translate-y-1/2 -right-5 opacity-20" style={{ width: '55%', height: '55%' }}>
                      <svg viewBox="0 0 24 24" fill="none" className="w-full h-full">
